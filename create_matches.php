                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Create Matches</h4>
                        </div>
                        <!-- End page title box -->
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <label>Match Date</label>
                                         <input type="date" class="form-control" name="date" placeholder="Enter match time">   
                                       </div>
    								   
                                       <div class="form-group">
                                            <label>Match time</label>
        								   <input type="time" class="form-control" name="time" placeholder="Enter match time" />
    								   </div>
    								    <div class="form-group">
...
if(isset($_POST['save'])){
    ...
    $match_status='to_be_started';
    $create_match=$mysqli->prepare("INSERT INTO match_master(Opponent_1,Opponent_2,Match_Date,Match_Time,Match_Status) VALUES (?,?,?,?,?)");
    $create_match->bind_param("sssss",$op,$ot,$date,$time,$match_status);
    $create_match->execute();
    $create_match_count=$create_match->num_rows;
    if($create_match_count<=0){
        ?>
