            ...
            <div class="content-page">
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-title"><a href="update_score.php"><button>Update Score</button></a></div>
                                <div class="card-box">
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap">
                                        ...
                                        <tbody>
                                            <?php
                                            $check_match=$mysqli->prepare("SELECT Match_id,Opponent_1,Opponent_2 FROM match_master");
                                            ...
                                            $check_match->bind_result($Match_id,$Opponent_1,$Opponent_2);
                                            while($check_match->fetch()){
                                                
                                                ?>
                                                <tr>
                                            <td><?php echo $Opponent_1;?>
                                             </td>                                   
                                                        </tr>
                                            <tr>
                                            <td><?php echo $Opponent_2;?></td>
