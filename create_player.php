...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Crickfest | Create player</title>
								   ...
								   <form method="post" >
                                        ...
                                        <label>Team Name</label>
                                            <select class="form-control" name="team_id">
                                                ...
                                                <?php
                                            $check_team=$mysqli->prepare("SELECT `team_id`, `Team_Name` FROM `team_master`");
                                            ...
                                            $check_team->bind_result($team_id,$Team_Name);
                                            while($check_team->fetch()){
                                                ?>
    								   ...
    								   <div class="form-group">
        								   <label>Player City</label>
        								   <input type="text" class="form-control" name="city" placeholder="Enter Player City" />
    								   </div>
    								    <div class="form-group">
...
if(isset($_POST['save'])){
    ...
    $create_player=$mysqli->prepare("INSERT INTO players_master(team_id,Player_name, Player_Category, Player_Role,Player_City) VALUES (?,?,?,?,?)");
    $create_player->bind_param("issss",$team_id,$name,$category,$role,$city);
    $create_player->execute();
    $create_player_count=$create_player->num_rows;
    if($create_player_count<=0){
        ?>
        <script type="text/javascript">
            alert('Player Added Sucessfullly');
        ...
        ?>
        <script type="text/javascript">
            alert('Player Added Unsucessfully');  
        </script>
        <?php
    }
}
