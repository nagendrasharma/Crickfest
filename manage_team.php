            ...
            <div class="content-page">
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
							    <div class="card-title"><a href="create_team.php"><button>Create Team</button></a></div>
                                <div class="card-box">
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap">
                                        ...
                                        <tbody>
                                        <?php
                                            $check_team=$mysqli->prepare("SELECT team_id, Team_Name,Team_Zone FROM team_master");
                                            ...
                                            $check_team->bind_result($team_id,$Team_Name,$Team_Zone);
                                            while($check_team->fetch()){
                                                
                                                ?>
                                                <tr>
                                            <td><?php echo $Team_Name;?></td>
                                            <td><?php echo $Team_Zone;?></td>
