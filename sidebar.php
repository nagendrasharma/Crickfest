                ...
                <div class="slimscroll-menu">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
							...
							<li>
                                <a href="manage_match.php">
                                    <i class="mdi mdi-view-dashboard"></i> <span> Manage Matches </span>
                                </a>
                            </li>

                                <li>
                                <a href="manage_team.php">
                                    <i class="mdi mdi-view-dashboard"></i> <span> Manage Teams </span>
                                </a>
                            </li>

                            <li>
                                <a href="manage_player.php">
                                    <i class="mdi mdi-view-dashboard"></i> <span> Manage Players </span>
                                </a>
                            </li>
